...
# You will learn more about nesting in module {{_globals._moduleNumber}}.7 ‒ for the time being, we just want you to be aware that something like this is possible, too.""")
...
# Again, you will learn more about this in module {{_globals._moduleNumber}}.6 ‒ don't worry. For the time being just try to experiment with the above code and check how changing it affects the output.
